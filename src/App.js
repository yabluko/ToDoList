...
function App() {
  ...
  const [listItem, updateItem] = useState(null);
    ...
    <div className="todo">
      <div className="todo__sidebar">
        <div className="todo__list">
          ...
          />
          {lists ? (<List items={lists} onItem={item => { updateItem(item) }} activeItem={listItem} isRemovable onRemove={id => {
      ...
      <div className="todo__tasks">
        {listItem && <Tasks list={listItem} onItem={editListTitle} newTask={newTask}  />}
      </div>
    </div>
  );
}
